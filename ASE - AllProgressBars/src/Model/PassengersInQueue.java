...
public class PassengersInQueue {
	...
	// based threading
	private Object Ecolockput = new Object();
	private Object FIRSTBS = new Object();
	private Object ECOPICKLOCK = new Object();
	private Object BSPICKLOCK = new Object();
	private Object SECULOC = new Object();
	private Object BORADLOCK = new Object();
			...
			while (true) {
				...
				try {
					...
					for (int i = 0; i <= q1.size(); i++) {
						...
						double volumeCapacity = ((b.baggageVolume()/40000)*100);
                        ...
                        if (p.getflightCode().equalsIgnoreCase("QA410")) {
                        	...
                        	System.out.println("Qantas QA410 flight weight capacity reached is " +QAtotalWeightCapacity() + "%");
    						System.out.println("Qantas QA410 flight volume capacity reached is " + QAtotalVolumeCapacity() + "%");
    						System.out.println("Total excess baggage fees collected for Qantas QA410 is " + QAtotalExcessFeesCollected() + " GBP.");
						}
						else if (p.getflightCode().equalsIgnoreCase("BA808")) {
							
							System.out.println("British Airways BA808 flight weight capacity reached is " +BAtotalWeightCapacity() + "%");
    						System.out.println("British Airways BA808  flight volume capacity reached is " + BAtotalVolumeCapacity() + "%");
    						System.out.println("Total excess baggage fees collected for British Airways BA808 is " + BAtotalExcessFeesCollected() + " GBP.");
						}
						
                        else if (p.getflightCode().equalsIgnoreCase("EA203")) {
							
                        	System.out.println("Emirates EA203 flight weight capacity reached is " +EAtotalWeightCapacity() + "%");
    						System.out.println("Emirates EA203 flight volume capacity reached is " + EAtotalVolumeCapacity() + "%");
    						System.out.println("Total excess baggage fees collected for Emirates EA203 is " + EAtotalExcessFeesCollected() + " GBP.");
						}
	...
	public LinkedList<Baggage> getB() {
		return Bags;
	}
	...
	public double QAtotalWeightCapacity() {
	...
	public double QAtotalVolumeCapacity()
	{
		double sum = 0;
	...
	public double QAtotalExcessFeesCollected()
	{
		double sum = 0;
	...
	public double BAtotalWeightCapacity() {
		...
		public double BAtotalVolumeCapacity()
		{
			double sum = 0;
		...
		public double BAtotalExcessFeesCollected()
		{
			double sum = 0;
		...
		public double EAtotalWeightCapacity() {
			...
			public double EAtotalVolumeCapacity()
			{
				double sum = 0;
			...
			public double EAtotalExcessFeesCollected()
			{
				double sum = 0;
