...
//		FirstandBusinessDesk.add(buttonPanel1, BorderLayout.SOUTH);
	...
	public void disableProcessButton() {
		...
		SwingWorker<Boolean, String> EconomyWorker = new SwingWorker<Boolean, String>() {
		...
		SwingWorker<Boolean, String> FirstWorker = new SwingWorker<Boolean, String>() {
		...
		SwingWorker<Boolean, String> SecurityWorker = new SwingWorker<Boolean, String>() {
		...
		SwingWorker<Boolean, String> BoardingWorker = new SwingWorker<Boolean, String>() {
		...
		SwingWorker<Boolean, String> FirstCheckinWorker = new SwingWorker<Boolean, String>() {
		...
		SwingWorker<Boolean, String> EconomyCheckinWorker1 = new SwingWorker<Boolean, String>() {
