...
public class PassengerSetTest {
	 ...
	 * 
	 * @result Assert this by checking that the list has increased in size, 
	 * contains the addition and doesnt contain the other passenger object to ensure. 
	 */
		 @Test
			public void testAdd() {
		 ...
		 /**
		  * Tests that the method is indeed recognising when a specific object is held within the arraylist 'testPassengerSet' 
		  * 
		  * @result Asserts that it recognises the added passenger is present in the list, but not one that has not been added to the list   
		  */
		  ...
		  * 
		  * @result Passes if the specified passenger is present before but not after the method is called 
		  */
		  ...
		  * 
		  * For the purposes of this test, we simply prove that it does pull out an object present from within the list.
		  * 
		  ...
		  * 
		  * @result int output of the size of each list, passes test if it gets the correct size before and after adding an object to a list
		  */
