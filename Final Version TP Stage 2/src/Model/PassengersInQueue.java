...
/**
 * Advanced Software Engineering - Coursework Class to acquire and relay all
 * information about passengers, their associated baggage and respective flights
 * to the GUI as all the threads are executed concurrently on the programme.
 * 
 * @author Lynsey Kirk, Kuda Mugara, Rachana Patel, Cameron Scott, Robert Stone
 *
 */
public class PassengersInQueue extends Observable {
	...
	// Linked list shared data structures to store economy class passengers
	// generated by the
	// Producer thread
	...
	// Linked list shared data structures to store business or first class
	// passengers generated by the
	// Producer thread
	...
	/**
	 * Returns linked list with economy class passengers for economy check-in queue
	 * 
	 * @return economy passenger linked list
	...
	/**
	 * Returns linked list with first and business passengers for first/business
	 * check-in queue
	 * 
	 * @return first/business passenger linked list
	 * @throws InterruptedException
	 */
	// method used in producer thread to populate the linked list data structures
	...
	/**
	 * Returns the baggage object associated with the economy class passenger
	 * 
			...
			try {
				...
				for (int i = 0; i < q1.size(); i++) {
					...
					if (p.getflightCode().equalsIgnoreCase("QA410")) {
						...
						System.out.println(
								"Qatar QA410 flight weight capacity reached is " + QAtotalWeightCapacity() + "%");
						System.out.println(
								"Qatar QA410 flight volume capacity reached is " + QAtotalVolumeCapacity() + "%");
						System.out.println("Total excess baggage fees collected for Qatar QA410 is "
					...
					String excessVolume = b.excessBaggageVolume() + " cubic inches.";
					String excessWeight = b.excessBaggageWeight() + " Kg.";
					String volumeFees = b.excessVolumeFee() + " GBP.";
					String weightFees = b.excessWeightFee() + " GBP.";
					String fees = b.excessBaggageFee() + " GBP.";
					Log log = Log.getInstance();
					log.logCheckInDesk(passengerClass, name, flightCode, bag, bagWeight, fees, excessVolume,
							excessWeight, volumeFees, weightFees);
	...
	/**
	 * Returns the baggage object associated with the first or business class
	 * passenger
	 * 
	 * @return baggage object
	 * @throws InterruptedException
	...
	/**
	 * Returns linked list of passengers who have checked in & cleared security
	 * 
	 * @return
	 * @throws InterruptedException
	 */
	...
	/**
	 * Returns linked list of passengers checked-in, cleared security and boarded
	 * 
	 * @return
	 * @throws InterruptedException
	 */
	...
	/**
	 * The methods relating to linked lists are synchronised so as to ensure safe
	 * modification such as acquiring and removing list elements when multiple
	 * threads are accessing the lists concurrently.
	 * 
	 * 
	 * @return list of passengers queueing for check-in
	 */
	...
	/**
	 * @return list of passengers who have checked-in
	 */
	...
	/**
	 * @return list of passengers who have checked-in and ready for security
	 */
	...
	/**
	 * @return list of passengers who have cleared security
	 */
	...
	/**
	 * @return list of passengers who are queueing for boarding
	 */
	...
	/**
	 * @return list of passengers who have boarded Qatar Airways flight
	 */
	...
	/**
	 * @return list of passengers who have boarded British Airways flight
	 */
	...
	/**
	 * @return list of passengers who have boarded Emirates Airlines flight
	 */
	...
	/**
	 * @return list of baggage associated with boarded passengers
	 */
	...
	/**
	 * Return sum of Qatar Airways flight weight capacity after each increment
	 * 
	...
	/**
	 * Return sum of Qatar Airways flight volume capacity after each increment
	 * 
	...
	/**
	 * Return sum of Qatar Airways excess baggage fees collected after each
	 * increment
	 * 
	...
	/**
	 * Return sum of British Airways flight weight capacity after each increment
	 * 
	 * @return total weight capacity
	 */
	...
	/**
	 * Return sum of British Airways flight volume capacity after each increment
	 * 
	 * @return total volume capacity
	 */
	...
	/**
	 * Return sum of British Airways excess baggage fees collected after each
	 * increment
	 * 
	 * @return total excess baggage fees
	 */
	...
	/**
	 * Return sum of Emirates flight weight capacity after each increment
	 * 
	 * @return total weight capacity
	 */
	...
	/**
	 * Return sum of Emirates flight volume capacity after each increment
	 * 
	 * @return total volume capacity
	 */
	...
	/**
	 * Return sum of Emirates excess baggage fees collected after each increment
	 * 
	 * @return total excess baggage fees
	 */
