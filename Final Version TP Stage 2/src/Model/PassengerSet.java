...
/**
 * Advanced Software Engineering - Coursework class to create the data
 * structures for holding passengers, create the methods to add the passenger
 * objects to those data structures and return the passengers by iterating
...
public class PassengerSet {
	...
	/**
	 * Creates an array list for the passengers
	 */
	public PassengerSet() {
	...
	/**
	 * Returns the total number of passengers in the PassengerSet array list
	 * 
	 * @return
	 */
	...
	/**
	 * Randomly selects Passenger object from the PassengerSet array list
	 */
	 ...
	 * Returns a list of passengers by iterating through the PassengerSet
	 * 
	 * @param inputfile "passengers"
	 * @return PassengerSet p
	 * 
	 */
	...
	/**
	 * Removes Passenger Object
	 * 
	 * @param PassengerSet array list
	 * 
	 * 
	 */
	...
	/**
	 * Check if the Passenger object is present
	 * 
	 * @param PassengerSet array list
	 * 
	 * 
