...
public class GUIMain extends JFrame implements Observer {
	...
	private JPanel northPanel, centerPanel, southPanel, FirstandBusinessDesk, EconomyDesk1, EconomyDesk2, EconomyDesk3,
			buttonPanel1, buttonPanel2, buttonPanel3, buttonPanel4, checkinQueue, firstcheckinQueue, securityQueue, bQ;
	...
	private JTextArea desk1TxtArea, desk2TextArea, desk3TextArea, desk4TextArea, checkinQueueTxtArea,
			firstcheckinQueueTxtArea, securityQueueTxtArea, bTxtArea;
	private ImageIcon em, ba, qa, plane;
	private JScrollPane checkinQueueScroll, firstcheckinQueueScroll, securityQueueScroll, bQS;
	private JLabel desk1Lbl, desk2lbl, desk3lbl, desk4lbl, checkinQueuelabel, firstcheckinQueuelabel,
			securityQueuelabel, bQL;
	...
	private void setupSouthPanel() {
		...
		southPanel.setLayout(new GridLayout(0, 4, 0, 0));
	...
	public void disableProcessButton() {
		...
		SwingWorker<Passenger, String> EconomyCheckinWorker1 = new SwingWorker<Passenger, String>() {
			...
			protected void process(List<String> chunks) {
				...
				desk2TextArea.setText(gecocheckin);
				}
		};
		...
		SwingWorker<Passenger, String> EconomyCheckinWorker2 = new SwingWorker<Passenger, String>() {
			...
			protected void process(List<String> chunks) {
				String gecocheckin = chunks.get(chunks.size() - 1);
				desk3TextArea.setText(gecocheckin);
				}
		};
		...
		SwingWorker<Passenger, String> EconomyCheckinWorker3 = new SwingWorker<Passenger, String>() {
			...
			protected void process(List<String> chunks) {
				String gecocheckin = chunks.get(chunks.size() - 1);
				desk4TextArea.setText(gecocheckin);
				}
		};
