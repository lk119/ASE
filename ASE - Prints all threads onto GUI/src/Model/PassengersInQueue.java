...
public class PassengersInQueue {
	...
	private final int ECOLIMIT = 10;
	private final int FIRSTLIMIT = 10;
	...
	// method to pick Economy class passenger as the Consumer form the linked list
		// q1
		public Passenger EconomyPicker1() throws InterruptedException {
		...
		// method to pick Economy class passenger as the Consumer form the linked list
				// q1
				public Passenger EconomyPicker2() throws InterruptedException {
	...
	public double BAtotalWeightCapacity() {
		...
		public double EAtotalWeightCapacity() {
			...
			public void setCurrentPassenger(String currentPassenger) {
