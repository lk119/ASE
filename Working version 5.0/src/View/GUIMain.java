...
public class GUIMain extends JFrame implements Observer {
	...
	private JPanel northPanel, centerPanel, southPanel, FirstandBusinessDesk, economyDesk1, economyDesk2, economyDesk3,
			...
			timerPanel, feePanel, eaFeesArea, qaFeesArea, baFeesArea, countdownPanel;
	...
	private JTextArea desk1TxtArea, ecoDesk1TxtArea, ecoDesk2TxtArea, ecoDesk3TxtArea, checkinQueueTxtArea,
			...
			qatarTxtArea, timeArea, baInnerFeeArea, qaInnerFeeArea, eaInnerFeeArea;
	private JTextField countdownInput;
	...
	private JLabel desk1Lbl, ecoDesk1Label, ecoDesk2Label, ecoDesk3Label, checkinQueuelabel, firstcheckinQueuelabel,
			...
			qaPassengerLabel, eaPassengerLabel, timerLabel, feeLabel, eaFeeAreaLabel, baFeeAreaLabel, qaFeeAreaLabel,
			eaFeesLabel, baFeesLabel, qaFeesLabel, countdownLabel;
	...
	public int time = 120, timeForClosing = 110;
	...
	private void setupSouthPanel() {
		...
		eaFeeAreaLabel = new JLabel("Total Excess Fees");
		...
		baFeeAreaLabel = new JLabel("Total Excess Fees");
		...
		qaFeeAreaLabel = new JLabel("Total Excess Fees");
	...
	public void startDisplay() {
		...
		SwingWorker<Void, LinkedList<Passenger>> EconomyWorker = new SwingWorker<Void, LinkedList<Passenger>>() {
			...
			protected synchronized void process(List<LinkedList<Passenger>> chunks) {
				 ...
				 * 
				 * try { Void statusMsg = get();
				 * checkinQueueTxtArea.setText("This Desk Is Now Closed");
				 * 
				...
				for (Passenger p : gboarding) {
					...
					try {
						...
						boardingQueueTxtArea.append(new Date() + "\n" + p.getFullName() + " is now boarding "
								+ p.getflightCode() + " flight." + System.lineSeparator() + "Total passengers boarded: "
