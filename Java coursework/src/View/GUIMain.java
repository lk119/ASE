...
//MVC pattern - allows listeners to be added
	...
	public void start() {
		 ...
		 System.out.println("BANANAS THIS IS THE WAITING Q METHOD");
...
//				List<Message> retrieveMessages = new ArrayList<Message>();
				...
				for (Message message : passengersinqueue.getMessages()) {
					...
					System.out.println("BANANAS BANANANS BANANANANANANANANAS IM IN DEEPER BACKGROUND");
...
//		
//		 System.out.println("BANANAS THIS IS THE UPDATE LOG METHOD");
//		 
